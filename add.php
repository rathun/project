...
<div class="container bg-primary p-4">
	...
	<div class="col-sm-6">
		...
		<div class="container pt-5">
			...
			<button class="btn-light text-light"><a href="selecttt.php"><b>SEE DETAILS</b></a></button>
			<button class="btn-light text-light"><a href="logout.php"><b>LOGOUT</b></a></button>
		</div>
...
if(isset($_POST['submit']))
{
	...
	$insertt = "INSERT INTO details( name, status, rent,email,contact,room,balcony,description,address,image) VALUES('$name','$status','$rent','$email','$contact','$room','$balc','$bath','$address','$img') ";
	$query=mysqli_query($con,$insertt);
	if($query)
	{
		?>
		<script>
